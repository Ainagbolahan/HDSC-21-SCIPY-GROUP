...
# Making predictions 
    prediction = classifier.predict(np.array( [[No_of_FTE_Students, No_of_students_per_staff,International_Students, Teaching, Research, Citations, Industry_Income, International_Outlook]]))
    if prediction <= 0:
        pred = 'Badly Ranked'
    else:
        pred = 'Good Ranking'
